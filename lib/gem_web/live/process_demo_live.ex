defmodule GemWeb.ProcessDemoLive do
  ...
  def handle_event("select_count", %{"count" => count_str}, socket) do
    {:noreply,
     socket
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                <form phx-change="select_count">
                  ...
                  >
                    <option value="1000">1,000 processes</option>
                    <option value="10000">10,000 processes</option>
                    <option value="100000">100,000 processes</option>
                    <option value="1000000">1,000,000 processes</option>
                  </select>
                </form>
              </div>
            </div>
